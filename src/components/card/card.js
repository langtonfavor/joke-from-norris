                ...
                <div >
                 ...
                 <div class="profile-card__cnt js-profile-cnt">
                         ...
                         <div class="joke-card-ctr">
                             <button class="profile-card__button button--green js-message-btn" onClick={() => { this.nextJoke("Random") }}>Generate</button>
                             <button class="profile-card__button button--grey" onClick={() => { this.nextJoke(joke.categories[0]) }}>Go To The Next</button>
                         </div>
                     </div>
